...
<body>
	<div>
		<table bgcolor="#e6af0b" width="100%" border="0" cellspacing="0"
			cellpadding="0">
			<tr>
				<td><img src="images\\logo.png" style="height: 110px; width:100px; padding-left:5px;border-radius:72px;" /></td>
				<td>
					<h1><center>
						<b>BSSVEDU<h6>(SSVITS)</h6></b></center>
					</h1>
					<h4>
