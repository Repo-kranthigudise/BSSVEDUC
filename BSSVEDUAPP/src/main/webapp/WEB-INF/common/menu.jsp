...
<body>
	...
	<div class="lmenu">
		<ul>
			...
			<li><a href="${pageContext.request.contextPath}/gvtat">GOVTATTESTATION</a>
			<li><a href="${pageContext.request.contextPath}/works">SOCIALWORKS</a></li>
		</ul>
		<div class="pera">
			<P>
				&nbsp;&nbsp;&nbsp;<b>This site is only for Student Education for
					learning Courses <u><b>WWW.BSSVEDU.IN</b></u> offers to joining and
					learn more courses in this site.a Student can search which course
					he need.. that course information he can get on that course menu
